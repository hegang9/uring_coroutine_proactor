...
class AsyncReadAwaitable
{
  public:
    ...
    AsyncReadAwaitable(TcpConnection *conn, char *userBuf, std::size_t userBufCap, std::size_t nbytes)
        : conn_(conn), nbytes_(nbytes), userBuf_(userBuf), userBufCap_(userBufCap)
    {
    }
