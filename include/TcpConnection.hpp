...
class TcpConnection : public std::enable_shared_from_this<TcpConnection> {
 public:
  ...
  TcpConnection(const std::string& name, EventLoop* loop, int sockfd,
  ...
  // 提供获取输入缓冲区的接口
  void*& getCurReadBuffer() { return curReadBuffer_; }
  size_t& getCurReadBufferSize() { return curReadBufferSize_; }
  size_t& getCurReadBufferOffset() { return curReadBufferOffset_; }
  void setCurReadBuffer(void* buf) { curReadBuffer_ = buf; }
  void setCurReadBufferSize(size_t size) { curReadBufferSize_ = size; }
  void setCurReadBufferOffset(size_t offset) { curReadBufferOffset_ = offset; }
